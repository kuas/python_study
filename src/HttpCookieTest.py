...
# http://112.95.150.236:6806/Api/Doctor/login.ashx?Username=doctorA&password=999999

initOpeners(1)

req = openers[0].open("http://112.95.150.236:6806/Api/Doctor/SearchPatient.ashx").read()

print(req.decode('utf-8'))

req = openers[0].open("http://112.95.150.236:6806/Api/Doctor/login.ashx?Username=doctorA&password=999999").read()

print(req.decode('utf-8'))

req = openers[0].open("http://www.douban.com/online/11865076/album/137771083/").read()

print(req.decode('utf-8'))

downLoadImage("http://bbs.csdn.net/topics/390858257", "D:\\test.htm")

print(openers[0].addheaders )
